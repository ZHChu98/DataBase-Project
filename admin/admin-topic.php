...
if (isset($_POST["search-meth"]) && isset($_POST["search-info"])) {
  ...
  $sql = "SELECT DISTINCT * FROM ydzc_top WHERE $method like '%$keyword%'";
...
<body>
  ...
  <div class="container">
    <div class="row">
        <form action="admin-topic.php" method="post">
          <select class="bootstrap-select" data-style="btn-info" name="search-meth" >
            <optgroup label="Picnic">
              <option value="top_name">invice id</option>
            </optgroup>
          </select>
...
<div class="container">
    <div class="row">
      <p style="text-align: center"><a href="addtopic.html"> add new topic! </a></p>
    </div>
  <div>
