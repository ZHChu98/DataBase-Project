...
<body>
  ...
  <div class="container">
    <div class="row">
      <form action="cust-profile-update.php" method="post">
        <table class="table table-striped">
          <?php
          $row = mysqli_fetch_assoc($result);
          echo "<tr><td>ID</td><td>{$row["cust_id"]}</td></tr>";
          echo "<tr><td>First Name</td><td><input type='text' name='fname' value='{$row["cust_fname"]}'></td></tr>";
          echo "<tr><td>Last Name</td><td><input type='text' name='lname' value='{$row["cust_lname"]}'></td></tr>";
          echo "<tr><td>Email</td><td><input type='text' name='email' value='{$row["cust_email"]}'></td></tr>";
          echo "<tr><td>Phone</td><td><input type='text' name='phone' value='{$row["cust_phone"]}'></td></tr>";
          echo "<tr><td>Identification Type</td><td><input type='text' name='idtype' value='{$row["cust_idtype"]}'></td></tr>";
          echo "<tr><td>Identification Number</td><td><input type='text' name='idno' value='{$row["cust_idno"]}'></td></tr>";
          ?>
        </table>
        <div>
          <button type="submit" class="btn btn-primary">Save</button>
          <a type="button" class="btn btn-primary" href="cust-home.php">Back</a>
        </div>
      </form>
    </div>
  </div>
